                    ...
                    <div className="md:flex gap-2 space-y-6 md:space-y-0">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-2 flex">
                                <div className="w-max rounded-s-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:outline-none focus:ring-inset focus:ring-sky-600 sm:text-sm/6">
                                    +91
                                </div>
                                <input
                                    id="phone"
                                    ...
                                    autoComplete="phone"
                                    className="block w-full rounded-e-md border-0 px-1 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:outline-none focus:ring-inset focus:ring-sky-600 sm:text-sm/6"
                                />
                            </div>
                        </div>
                    </div>
